  ...
  <div class="flex">
    ...
    >
      ...
      <nav class="mt-10">
        <div>
          <div
            class="flex items-center justify-between text-slate-500 px-6 py-2 cursor-pointer"
            @click="masterDropdown = !masterDropdown"
          >
            <div class="flex items-center">
              <svg
                class="w-5 h-5"
            ...
            <span :class="!masterDropdown ? 'flex' : 'hidden'">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
